...
export const SERVICES = [
  {
    ...
    image: '/images/product-photography/720d2680-0add-4140-aa03-4b9cb046f315.jpg',
  ...
  },
  {
    ...
    image: '/images/ai-model/c24e404e-f68c-474c-85b5-6e809e3dc25c.jpg',
    alt: 'E-commerce on-model product visual showing premium brown t-shirt',
    layout: 'image-right',
    alternateImages: [
      {
        url: '/images/ai-model/8f00879e-b69a-49b2-b284-0389909d1dbb.jpg',
      ...
      {
        url: '/images/ai-model/f502627d-4a03-4e74-9458-a67c3a852e95.jpg',
  ...
  },
  {
    ...
    image: '/images/lifestyle/8199a959-6cf3-47d1-9694-ea357814f34e.jpg',
  ...
  },
  {
    ...
    image: '/images/marketplace/f2ff9b67-c343-453d-bd69-57acf65847e2.jpg',
    alt: 'Marketplace infographic feature breakdown for STRYD performance sneakers',
    layout: 'image-right',
    alternateImages: [
      {
        url: '/images/marketplace/67474991-eaa1-45b9-99f7-415aa970bdaa.jpg',
  ...
  },
  {
    ...
    image: '/images/social-ads/8d2d3428-bc55-41f2-a57b-85b4df698f7c.jpg',
    alt: 'High-conversion performance ad creative for C-Glow skincare serum',
    layout: 'image-left',
    alternateImages: [
      {
        url: '/images/social-ads/e951052e-dfd1-48f4-81a1-623c77ffffc2.jpg',
  ...
  },
  {
    ...
    image: '/images/ugc/01_RAW/WhatsApp Image 2026-09-01 at 12.44.08 PM.jpeg',
    ...
    alternateImages: [
      ...
      {
        url: '/images/ugc/01_RAW/WhatsApp Image 2026-09-01 at 12.46.24 PM.jpeg',
